...
public class Employee {
    ...
    public Employee(UUID id, Name name, Password password, Username username, EmailAddress emailAddress, HoursPerWeek requiredHoursPerWeek, EmployeeStatus status, EmployeeRole role) {
        this.id = id;
        this.name = name;
